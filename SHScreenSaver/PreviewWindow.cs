...
//			_transition = new ImageTransitions.ImageTransition(_hwnd,
//				bounds, Settings.Instance.TransitionEffect, Settings.Instance.RandomizeEffects,
//				Settings.Instance.ImagePaths, true, new System.Drawing.PointF(0, 0));
